export const lang_blog = {
    tr: {
        ...
        password: 'şifre',
        sign_up: 'ÜYE OL',
        disabled: 'Kayıt geçici olarak devre dışı bırakıldı.',
        back: 'Geri dön.',
        reset_password: 'Şifreyi Sıfırla',
        forgot_email: 'Şifrenizi mi unuttunuz? Sıfırlamak için e-postanızı girin.',
        reset: 'SIFIRLA',
        error: 'Hata:',
    ...
    en: {
        ...
        password: 'password',
        sign_up: 'SIGN UP',
        disabled: 'Registration has been temporarily disabled.',
        back: 'Back to',
...
export function getLangBlog() {
    let local_lang;
    try { local_lang = localStorage.getItem('lang'); }
    catch (e) { }
    return local_lang === 'tr' ? 'tr' : 'en';
};